...
EXTERNAL_API_DICT = ({"product": {"available_to_promise_network": {
    "product_id": "13860428",},"item": {"product_description": {
    "title": "The Big Lebowski (Blu-ray)",}}}})

RETURNED_PRODUCT = ({"id":13860428,
...
class TestProductsAPI(unittest.TestCase):
    ...
    def test_on_get(self, common, json_dumps):
        ...
        self.assertEqual(RETURNED_PRODUCT['current_price'], resp.body['current_price'])
    ...
    def test_on_put(self, common):
        ...
        self.assertEqual('New Product Value Written to Database Successfully', resp.body)
